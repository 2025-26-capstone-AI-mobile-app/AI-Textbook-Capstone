...
<img src="AIChat.png" width=500 alt="Two screenshots of a phone screen. Left image shows UI for starting a new chat or open an old one. Right is an example chat session">
...
### AI Flashcards
<img src="FlashcardsOverlay1.png" width=150 alt="UI to prompt AI to make flashcards">
<img src="FlashcardEX.png" width=150 alt="An example flashcard">
<img src="FlashcardsResult.png" width=150 alt="The results page for the flashcards feature">
...
### AI Quizzes
<img src="QuizGenerator.png" width=150 alt="UI for asking AI to generate quiz">
<img src="QuizEX.png" width=150 alt="Example quiz generated by the AI">
<img src="QuizEXAnswers.png" width=150 alt="Graded example quiz generated by the AI">
